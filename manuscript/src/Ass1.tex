...
\input{tables/Ass1_comparing_methods.tex}
\end{table}
...
\input{tables/Ass1_D1_raw_signal.tex}
\end{table}

\begin{figure}[]
    \centering
    \begin{minipage}[b]{1\textwidth}
        \includegraphics[width=\textwidth]{figures/Ass1_D1_raw_signal.png}
    \end{minipage}
...
\begin{figure}[]
    \centering
    \begin{minipage}[b]{1\textwidth}
        \includegraphics[width=\textwidth]{figures/Ass1_D1_seasonal_decompose.png}
    \end{minipage}
    \caption{De.}
