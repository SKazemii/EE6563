...
\begin{document}
    ...
    \input{Questions/0-titleAbstract}

    \input{Questions/1-introduction}

    \input{manuscript/src/Questions/2-Literature Review}

    \input{manuscript/src/Questions/3-Methodology}

    \input{manuscript/src/Questions/4-Results}

    \input{manuscript/src/Questions/5-Discussion Progress}
...
\input{manuscript/src/Questions/6-CNN}
