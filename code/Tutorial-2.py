...
import numpy as np
#reading the dataset
series = pd.read_csv('/Users/saeedkazemi/Downloads/AirPassengers.csv')
...
n=7
series['#Passengers_diff_season'] = series['#Passengers'] - series['#Passengers'].shift(n)
...
series['#Passengers_log_diff'] = series['#Passengers_log'] - series['#Passengers_log'].shift(1)
